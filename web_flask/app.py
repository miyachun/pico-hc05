...
parser = argparse.ArgumentParser(description='PICO HC-05 Serial.')
parser.add_argument('-p', '--port', metavar='PORT', nargs=1, required=True, help='Serial Port Where Pico Board is Connected.',)
